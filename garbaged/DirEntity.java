...
public class DirEntity extends FileTreeEntity  implements Iterable<FileImpl>  {
	private final ArrayList<FileImpl> children;
	...
	FileTreeEntity addChild(Path fileName, boolean isDir) throws IOException {
		...
		FileTreeEntity f = isDir ? new DirEntity(fileName, this) : new FileImpl(fileName, this);
		children.add(f);
		return f;
	}
	...
	void sort(Comparator<FileImpl> comparator) {
